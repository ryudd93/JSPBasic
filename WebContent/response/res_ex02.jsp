...
<body>
	...
	<!-- 내부 스타일 시트는 태그에 class속성을 이름을 부여하고, head안에서 css문법으로 디자인을 적용 -->
	<section>
	
		<div class="form-content">
			
			<form action="res_ex02_result.jsp" method="post" class="form-group" style="">
				<span>로그인 폼</span>
				<input type="text" name="id" placeholder="ID" class="form-control"><br>	
				<input type="text" name="pw" placeholder="PASSWORD" class="form-control"><br>	
